...
namespace VstsServerTaskHelper.ServiceBusMessageHandler
{
    public class RetryEventHandler : IRetryEventHandler
    {
        ...
        public RetryEventHandler(string eventName, IDictionary<string, string> eventProperties, CancellationToken cancellationToken, HashSet<HttpStatusCode> transientStatusCodes = null)
        {
