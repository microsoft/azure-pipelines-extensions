### In basic example, Azure Function checks that the that the invoking pipeline contains at least one CmdLine task in the previous stages prior to the check point.
