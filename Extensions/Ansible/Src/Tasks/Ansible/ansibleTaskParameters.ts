  ...
  private initializeAnsibleParameters() {
    ...
    if (this.ansibleInterface == "remoteMachine") {
      ...
      if (this.playbookSource == "agentMachine") {
        ...
        this.playbookPath = tl.getInput(
          "playbookPathLinkedArtifactOnRemoteMachine",
          true
        );
      ...
      if (this.inventoryType == "file") {
        this.inventoryFileSource = tl.getInput(
          "inventoryFileSourceRemoteMachine",
          true
        );
        if (this.inventoryFileSource == "agentMachine") {
          this.inventoryFilePath = tl.getInput(
        ...
        this.inventoryHostList = tl.getInput(
          "inventoryHostListRemoteMachine",
          true
        );
      } else if (this.inventoryType == "inlineContent") {
        this.inventoryDynamic = tl.getBoolInput(
          "inventoryInlineDynamicRemoteMachine",
          false
        );
        this.inventoryInline = tl.getInput(
      ...
      if (this.inventoryType == "file") {
        ...
        this.inventoryDynamic = tl.getBoolInput(
          "inventoryInlineDynamicAgentMachine",
          false
        );
        this.inventoryInline = tl.getInput(
