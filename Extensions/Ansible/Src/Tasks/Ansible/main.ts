...
export class ansibleCommandLineInterfaceFactory {
  public static getCommandLineInterface(
    params: ansibleTaskParameters
  ): ansibleCommandLineInterface {
...
export class ansibleInterfaceFactory {
  public static GetAnsibleInterface(
    params: ansibleTaskParameters
  ): ansibleInterface {
...
function run() {
  try {
    ...
    var ansibleInterface: ansibleInterface =
      ansibleInterfaceFactory.GetAnsibleInterface(params);
    if (ansibleInterface) {
