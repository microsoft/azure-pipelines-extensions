...
// Telemetry (shadow mode) test: with only AZP_75787_ENABLE_COLLECT enabled the
...
// it.
process.env['DISTRIBUTEDTASK_TASKS_AZP_75787_ENABLE_COLLECT'] = 'true';
delete process.env['DISTRIBUTEDTASK_TASKS_AZP_75787_ENABLE_NEW_LOGIC'];
