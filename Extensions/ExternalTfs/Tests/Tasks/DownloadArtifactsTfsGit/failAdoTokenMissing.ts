...
// auth.getAccessTokenViaWorkloadIdentityFederation returns null -> ConnectionDetails
// will have AccessToken=null and Password=null; getGitClientPromise should throw
// "Password is not provided for the service connection."
registerAllMocks(tr, { adoAccessToken: null });
