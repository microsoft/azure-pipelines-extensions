...
// Uppercase parameter keys; getAuthParameter must resolve them case-insensitively.
setReposOrTfsEndpoint({ scheme: 'UsernamePassword', useUppercaseParameters: true });
