...
// gitClient.getRepository() resolves with `undefined` -> the null-repo guard
// in getRepositoryRemoteUrl should throw with the lookup-returned-null error.
registerAllMocks(tr, { webApi: { nullRepo: true } });
