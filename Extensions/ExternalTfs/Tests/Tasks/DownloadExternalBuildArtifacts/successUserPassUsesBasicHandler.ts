...
// UsernamePassword scheme -> non-empty username -> main() should pick the
// BasicCredentialHandler branch for the container download (vs the PAT
// handler used by the Token scheme).
