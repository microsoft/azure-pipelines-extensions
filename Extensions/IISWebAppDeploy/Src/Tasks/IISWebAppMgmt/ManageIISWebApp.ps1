...
function Main
{
    ...
    Validate-Inputs -createWebsite $createWebsite -websiteName $websiteName -createAppPool $createAppPool -appPoolName $appPoolName -sslCertThumbPrint $sslCertThumbPrint
