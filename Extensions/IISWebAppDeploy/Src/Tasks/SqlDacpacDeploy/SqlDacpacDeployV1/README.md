...
* Install the latest version of sqlpackage.exe by installing the **SQL Server Data-Tier Application Framework (October 2016)** from https://www.microsoft.com/en-us/download/details.aspx?id=54106. On x64 machines, install both the en\x86\DACFramework.msi and the en\x64\DACFramework.msi.
