...
async function main(): Promise<void> {
    var promise = new Promise<void>(async (resolve, reject) => {
        ...
        var templatePath = path.join(__dirname, 'circleci.handlebars');
        ...
        var webClient = webProvider.webClient;
        let commitsDownloader: CommitsDownloader = new CommitsDownloader(webProvider);
    });
